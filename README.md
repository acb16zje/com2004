...
The data in this assignment comes from pages of books. The test data has been artificially
...
Your task is to write a new version of `system.py`. Your solution must not change `train.py`,
